...
local Window = Rayfield:CreateWindow({
    Name = "Project Slayer Ouwigahara │ by Lauscript",
    LoadingTitle = "Sub 2 Lauscript",
    LoadingSubtitle = "Sub 2 Lauscript",
    ConfigurationSaving = {
        Enabled = true,
        FolderName = "Project Slayer Dungeon", -- Create a custom folder for your hub/game
    ...
    KeySystem = true,
    KeySettings = {
        Title = "Project Slayer Dungeon Key System",
        Subtitle = "Key System",
        Note = "Sub 2 Lauscript",
        FileName = "Project Slayer Dungeon", 
        SaveKey = true, 
...
local AutoInvincible = Main:CreateToggle({
    Name = "Invincible (Akaza BD) NEED 50 MASTERY",
    CurrentValue = false,
    Flag = "BuyExp",
    SectionParent = Settings,
    Callback = function(v)
